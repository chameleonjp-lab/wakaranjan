...
function renderPracticeIndex(app){
  app.innerHTML='<section class="lesson-head"><div class="eyebrow">対局練習</div><h1>牌を動かして、判断を練習する。</h1><p class="lead">最初は短い操作から始め、鳴き・リーチ・フリテンへ進みます。時間制限はなく、間違えてもすぐにやり直せます。</p></section><section class="callout"><strong>迷ったら、上から順に進めてください。</strong><br>手を動かす練習、正しいか判断する練習、一局の流れを見る練習を分けています。</section><section class="practice-group"><h2>はじめて</h2><div class="feature-grid practice-grid"><a class="feature-card practice-card practice-recommended" href="#practice?mode=draw-discard"><strong>1. ツモと捨て牌</strong><span>1枚取って、1枚捨てる基本操作</span></a><a class="feature-card practice-card practice-recommended" href="#practice?mode=calls"><strong>2. 鳴き</strong><span>手牌と相手の捨て牌を見て、鳴けるか判断</span></a><a class="feature-card practice-card practice-recommended" href="#practice?mode=riichi"><strong>3. リーチとあがり</strong><span>テンパイ、リーチ、ロンの順番</span></a></div></section><section class="practice-group"><h2>そのあと</h2><div class="feature-grid practice-grid"><a class="feature-card practice-card" href="#practice?mode=furiten"><strong>フリテン</strong><span>ロンできない場面とツモの関係</span></a><a class="feature-card practice-card" href="#practice?mode=hand-flow"><strong>一局の流れ</strong><span>鳴き・リーチ・流局を一つの入口から確認</span></a><a class="feature-card practice-card" href="#lesson-intro-06"><strong>案内付き一局</strong><span>ツモからロンまでを手順どおりに体験</span></a></div></section><details class="practice-details"><summary>詳しい練習を開く</summary><div class="feature-grid practice-grid"><a class="feature-card practice-card" href="#practice?mode=wall"><strong>牌山と王牌</strong><span>牌山、王牌、ドラ表示牌を確認</span></a><a class="feature-card practice-card" href="#practice?mode=kan"><strong>カンと嶺上ツモ</strong><span>暗槓・大明槓・加槓の後の処理を確認</span></a><a class="feature-card practice-card" href="#practice?mode=round-flow"><strong>局の進み方</strong><span>親の交代、連荘、本場、東風戦の終了</span></a><a class="feature-card practice-card" href="#practice?mode=east-round"><strong>模擬東風戦</strong><span>4局を通して局の進行と点数の変化を確認</span></a></div></details>'+nav();
}
