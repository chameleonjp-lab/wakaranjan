...
function save(v){try{localStorage.setItem(profileStorageKey(KEY),JSON.stringify(normalize(v)))}catch{}}
...
export function clearLessonProgress(){try{localStorage.removeItem(KEY);localStorage.removeItem(profileStorageKey(KEY))}catch{}}
