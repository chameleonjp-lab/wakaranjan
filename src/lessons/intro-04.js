...
const examples=[
  {title:'順子',codes:['2m','3m','4m'],ok:true,desc:'同じ種類で数字が3つ続く組です。'},
  {title:'刻子',codes:['7p','7p','7p'],ok:true,desc:'同じ牌3枚の組です。'},
  {title:'対子',codes:['white','white'],ok:true,desc:'同じ牌2枚の組です。'},
...
export function renderIntro04(app,ctx){
  ...
  const checks=[
    {codes:['2m','3m','4m'],prompt:'この3枚の組は？',choices:['順子','刻子'],answer:0},
    {codes:['7p','7p','7p'],prompt:'この3枚の組は？',choices:['順子','刻子'],answer:1},
    {codes:['white','white'],prompt:'この2枚の組は？',choices:['雀頭','面子'],answer:0}
  ];
  let checkIndex=0;
