...
export function renderIntro01(root,ctx){
  ...
  appendTileRow(root.querySelector('#shape-demo'),demo,{rowClass:'hand-fit-row'});
  ...
  function paint(){
    ...
    appendTileRow(handBox,hand,{rowClass:'hand-fit-row',interactive:drew,onSelect:(tile,_o,_el,index)=>discard(index),drawnIndex:drew?hand.length-1:-1});
