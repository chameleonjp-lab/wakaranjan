...
async function start(){
  try{
    ...
    const mergedProblemCatalog={...problemCatalog,questions:[...problemCatalog.questions,...visualCatalog.questions]};const terms=[...termData.terms,...termExtra.terms];
