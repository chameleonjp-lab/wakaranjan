...
function renderHome(ctx){
  ...
  <h2 class="section-title">問題</h2><div class="feature-grid"><a class="feature-card" href="#problems"><strong>問題に挑戦</strong><span>ロン牌・待ち、役名、点数計算の48問からランダム出題</span></a></div>
