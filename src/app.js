...
async function start(){
  try{
    const [tileData,lessonData,introReview,beginnerReview,waitData,callData,beginnerCore,yakuData,scoringCore,intermediateReview,termData,termExtra,yakuExamples,problemCatalog,visualCatalog,practicalRules,advancedSpecial,curriculumExtra]=await Promise.all([loadJson('./src/data/tiles.json'),loadJson('./src/data/lessons.json'),loadJson('./src/data/questions/intro/review.json'),loadJson('./src/data/questions/beginner/review.json'),loadJson('./src/data/waits.json'),loadJson('./src/data/calls.json'),loadJson('./src/data/beginner-core.json'),loadJson('./src/data/yaku.json'),loadJson('./src/data/scoring-core.json'),loadJson('./src/data/questions/intermediate/scoring-review.json'),loadJson('./src/data/terms.json'),loadJson('./src/data/terms-extra.json'),loadJson('./src/data/yaku-examples.json'),loadJson('./src/data/questions/catalog.json'),loadJson('./src/data/questions/visual-catalog.json'),loadJson('./src/data/questions/practical-rules.json'),loadJson('./src/data/advanced-special.json'),loadJson('./src/data/curriculum-extra.json')]);
