...
for(const [base,reading] of [['白','ハク'],['發','ハツ'],['中','チュン'],['門前ツモ','メンゼンツモ'],['捨て牌','ステハイ'],['東家','トンチャ'],['一通','イッツウ'],['牌姿','ハイシ'],['あがり牌','アガリハイ'],['表示牌','ヒョウジハイ'],['嶺上牌','リンシャンハイ'],['安全牌','アンゼンパイ'],['危険牌','キケンパイ']])assert.equal(map.get(base),reading,`${base} の読みが不適切です`);
